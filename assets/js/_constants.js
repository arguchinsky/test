...
export const mousePressStatesArray = ['ShiftLeft', 'ShiftRight', 'AltLeft', 'AltRight'];
export const defAlphabet = 'abcdefghijklmnopqrstuvwxyz';
export const altAlphabet = 'абвгдеёжзийклмнопрстуфхцчшщъыьэюя';
*/